package com.app.collapsing.utils;
...
import com.app.collapsing.R;

import de.hdodenhof.circleimageview.CircleImageView;

@SuppressWarnings("unused")
public class UserImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    public UserImageBehavior(Context context, AttributeSet attrs) {
        mContext = context;
